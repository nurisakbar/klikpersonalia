...
@section('title', 'Edit BPJS Record')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit BPJS Record</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('bpjs.index') }}">BPJS Management</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('bpjs.show', $bpjs) }}">BPJS Details</a></li>
                        <li class="breadcrumb-item active">Edit BPJS Record</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit BPJS Record Information</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('bpjs.update', $bpjs) }}" id="bpjsForm">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                                                <option value="pending" {{ old('status', $bpjs->status) == 'pending' ? 'selected' : '' }}>Pending</option>
                                                <option value="calculated" {{ old('status', $bpjs->status) == 'calculated' ? 'selected' : '' }}>Calculated</option>
                                                <option value="paid" {{ old('status', $bpjs->status) == 'paid' ? 'selected' : '' }}>Paid</option>
                                                <option value="verified" {{ old('status', $bpjs->status) == 'verified' ? 'selected' : '' }}>Verified</option>
                                            </select>
                                            @error('status')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror" 
                                              rows="3" placeholder="Additional notes...">{{ old('notes', $bpjs->notes) }}</textarea>
                                    @error('notes')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Update BPJS Record
                                    </button>
                                    <a href="{{ route('bpjs.show', $bpjs) }}" class="btn btn-secondary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-sm">
                                ...
                                <tr>
                                    <td><strong>Company Cont.:</strong></td>
