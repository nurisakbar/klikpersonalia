    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Edit Komponen Gaji</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Form Edit Komponen Gaji</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('salary-components.update', $salaryComponent->id) }}" method="POST" id="editComponentForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                        ...
                                        <option value="earning" {{ old('type', $salaryComponent->type) == 'earning' ? 'selected' : '' }}>Pendapatan</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="text-center">
                                ...
                                <h6>ID Komponen</h6>
                                <p class="text-muted">{{ Str::limit($salaryComponent->id, 8) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
