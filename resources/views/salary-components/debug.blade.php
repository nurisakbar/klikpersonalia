...
@section('title', 'Debug Salary Components')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Debug Salary Components</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="debug-table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
...
$(document).ready(function() {
    ...
    var table = $('#debug-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
